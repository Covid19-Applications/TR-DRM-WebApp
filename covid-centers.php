    ...
    <div class="bradcam_area breadcam_bg ">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        ...
                        <h1>Covid Care Centers</h1>
                            <p>Currently, there is 1 government laboratory approved to test for COVID-19 in Tripura.</p>
                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        <img src="img/centers/bg.jpg" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container  text-center">
        ...
        <div class="row col-lg-12">
          ...
          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/tripura/">Isolation Centers</a></h4>
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/tripura/">Quarantine Centers</a></h4>
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="covid-dashboard.php #index">Testing Centers</a></h4>
    ...
    <!-- Start Align Area -->
     ...
     <div class="whole-wrap">
        <div class="container box_1170">
            <div class="col-lg-12">
                     <h2 class="title-1 m-b-25" id="iso" >Covid19 Health Care Centers In Tripura</h2>
