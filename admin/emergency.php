    ...
    <div class="modal-content">
      ...
      <form action="code.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="state" value="tripura">  
...
?>
  ...
  <div class="table-responsive">
    <?php
        $query = "SELECT * FROM police_emergency  WHERE state = 'tripura' ";
   ...
   <div class="table-responsive">
    <?php
        $query = "SELECT * FROM ambulance_emergency  WHERE state = 'tripura' ";
        $query_run = mysqli_query($connection, $query);
    ?>
<!-- /.container-fluid -->
 ...
 <div class="table-responsive">
    <?php
        $query = "SELECT * FROM fire_emergency  WHERE state = 'tripura' ";
        $query_run = mysqli_query($connection, $query);
    ?>
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
