  ...
  background-color: gray;
	...
	<section class="sample-text-area">
		<div class="container box_1170">
			<p class="sample-text" style="text-align: center;">
                Ma Tripura offers its patients to choose from a wide network of well-qualified and experienced doctos across Tripura to ensure that the right healthcare decision is made.
			</p>
		</div>
	</section>
	<!-- End Sample Area -->
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Doctors In Tripura</h2>
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM doctors WHERE state = 'tripura'";
