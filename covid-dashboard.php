...
form #logout{
 ...
 <div class="main-content" style="background-color: #2d4159;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Global Confirmed Cases</span>
                                                <h2 id="GlobalConfirmed" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Global Recovered Cases</span>
                                                <h2 id="GlobalRecovered" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Indian Confirmed Cases</span>
                                                <h2 id="IndianConfirmed" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Indian Recovered Cases</span>
                                                <h2 id="IndianRecovered" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Tripura Confirmed Cases</span>
                                                <h2 id="StateConfirmed" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Tripura Recovered Cases</span>
                                                <h2 id="StateRecovered" style="color:white;"></h2>
                                            </div>
                                            <div class="progress">
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Tripura Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="color:white;">Covid19 Cases In Tripura</h2>
                            ...
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25" style="color:white;">Covid19 Cases In India</h2>
                                <div class="table-responsive table--no-card m-b-40">
                            ...
                            <div class="col-lg-3">
                                <h2 class="title-1 m-b-25" style="color:white;">Top countries</h2>
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="color:white;">Covid19 Test Cases In Tripura</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 700px;">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1quBs1mUjhjmOrwAI3niTwmJZOmSLJkwP" width="100%" height="480"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(20361490));
